...
2. **Living Memory (Architectural Invariants):** The high-level technical state stored in `agentmemory`. You initialize this in the **Discovery Phase** and update it automatically via the `T-Final` task in the **Tasks Phase**.
