...
2. Use the `Shell` tool to execute `<path-to-skill>/scripts/commit_spec.sh [feature]`. This script runs Python validation against your XML and, if successful, moves the files into the physically locked vault.
