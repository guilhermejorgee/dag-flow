...
> Derived from [`suite_e2e_implementation_plan.md`](file:///home/guilherme/Área de trabalho/Repos/dag-flow/docs/planning/archive/suite_e2e_implementation_plan.md)
> Root dir: `docs/benchmarks/data/e2e-v0.1.0/`
...
**Size:** S  
**Description:** Create the controlled target codebase that all scenarios run against. Pattern mirrors existing RBAC benchmark (`docs/benchmarks/data/rbac-api-showdown/`). Fresh Node.js/Express skeleton — agents build into it, not the dag-flow repo itself.
